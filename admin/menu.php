        ...
        <li class="nav-item dropdown menu-open">
          ...
          <?php if ($_SESSION['role'] == "super") { ?>
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item dropdown ">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?php echo $base_url ?>/sifath/m_manager_list.php" class="nav-link ">
                      <i class="fa fa-calculator nav-icon"></i>
                      <p>Marketing Manager Report</p>
                    </a>
                  </li>
                </ul>
              </li>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php //echo $base_url 
                          ?>/rubel/payament_dealer.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Payment Dealer wise</p>
                </a>
              </li>
          ...
          ?>
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php //echo $base_url 
                          ?>/tawhid/dealer_create.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create Dealer</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="<?php //echo $base_url 
                          ?>/tawhid/t_dealer_list.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dealers List</p>
                </a>
              </li>
