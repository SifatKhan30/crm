              ...
              <table class="table table-bordered">
                ...
                <tbody id="pID">
                    <?php while ($d = $data->fetch_assoc()) { 
                      ...
                      $da = $con-> query('select * from admin where id=' . $d['product_id'])->fetch_array();
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="edit_invoice.php?invoice_id=<?php echo $d['invoice_id'] ?>" class="btn btn-success btn-xs">Edit</a>
                        <a href="del_invoice.php?id=<?php echo $d['id'] ?>" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                        <a href="../amran/invoice_details.php?id=<?php echo $d['invoice_id'] ?>" class="btn btn-xs btn-primary">View</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
